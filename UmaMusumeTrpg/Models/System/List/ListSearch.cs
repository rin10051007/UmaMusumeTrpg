...
namespace UmaMusumeTrpg.Models.System.List
{
    ...
    {
        public ListSearch(string name, SotrDirection sortDirection, UmaMusumeTrpgPermission umaMusumeTrpgPermission, SystemSortItem sortItem, int displayPage, int displayCount) : base(sortDirection, displayPage, displayCount)
        {
            Name = name;
